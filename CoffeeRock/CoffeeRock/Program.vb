...
Module Program
    ...
    Public Async Function Run() As Task
        ...
        Console.WriteLine("Welcome to CoffeeRock!")
        Console.WriteLine("This program converts Minecraft Bedrock XUIDs to the Minecraft Java UUID format.")
        ...
        Using client As New HttpClient()
            ...
            Select Case response.IsSuccessStatusCode
                ...
                Case False
                    ...
                    Console.WriteLine("Make sure you typed the username correctly")
                    Console.WriteLine("Press any key to exit...")
                    Console.ReadKey()
                    End
            End Select
